...
| Map To Visit | Used to map a decoded visit name to the name used in the planned visits file | JSON dictionary where the key is the decoded visit name, and the value is the name of the visit from the planned visits file[^2] | {"Visit 0":"Baseline", "Visit 12": "Week 12"} |
| Column Mappings | Used to pivot the corresponding value to a specific column for every question, or to specify that the question should be skipped.[^3] | [NA], Study Day, User Defined ID, [VISIT] | [NA], Study Day, User Defined ID, [VISIT] |
...
| Study Day | Used to specify the field that contains the value of the study day for this question.[^4] | *Any string in the "Field Name" column for this form (the value in the "Table Name" column must be the same between this field and field specified)* | LATEX_DATE |
