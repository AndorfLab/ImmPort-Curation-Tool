...
<img src='images/study_search.png' width=350px alt='Search Page' style='display:block; margin:10px 0px 30px 10px'/>
...
4. Find the row in the Study Search Results table for the ImmPort Study, and click the link in the "Study Title" column. ![Search Page Results](images/study_search_results.png)
...
![Study Details: Study Files tab](images/study_details_study_files.png)
2. Scroll down to the "Study Files" table
3. Click on the "Options" button in the top-right of the table.
![Study Files table](images/study_files_table.png)
4. Click on "Export all data as csv"
5. Use this file with the Study Files file selector. 
![Select Study Files Filechooser](images/select_study_files.png)
